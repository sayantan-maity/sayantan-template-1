...
fetch("t1.json")
    ...
    .then(function (data) {
        ...
        document.getElementById('yourmail').innerHTML = obj.yourmailagain;

        // document.getElementById('yournumber').innerHTML = obj.yournumber;
        document.getElementById('yournumber').href = obj.yournumber;
        document.getElementById('yournumber').innerHTML = obj.yournumberagain;

        document.getElementById('logoimg').href =obj.logoimg;
        document.getElementById('logoimg2').src = obj.logoimg2;

        document.getElementById('ourcontact').innerHTML = obj.ourcontact;
    });